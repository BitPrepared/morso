...
DistUtilsExtra.auto.setup(
    ...
    #long_description='Software che permette di convertire del testo in codice morse e viceversa. MorsO permette inoltre di trasmettere il messaggio usando le bandiere oppure la torcia, impostando inoltre la velocità di trasmissione',
    #url='http://ncorti.it',
